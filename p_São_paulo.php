...
@$pacote= $valor_passagem + ($numero_acompanhantes * $valor_passagem)+$valor_passagem +( $numeros_dias *  550);
    mysqli_query($con, "insert into viagem values('','$id_cliente','$cpf','$id_cliente','$numero_acompanhantes','$numeros_dias','$cidade_destino','$estrela_5','$data_saida','$data_chagada','$valor_passagem','$pacote')");
