...
if ("hotel" == $estrela_1) {
  ...
  mysqli_query($con, "insert into viagem values('',$numero_acompanhantes','$numeros_dias','$cidade_destino','$estrela_1','$data_saida','$data_chagada','$valor_passagem')");

} else if ("hotel" == $estrela_2) {
 @$pacote=$valor_passagem + ($numero_acompanhantes * $valor_passagem)+ $valor_passagem +( $numeros_dias * 150);
    mysqli_query($con, "insert into viagem values('',$numero_acompanhantes','$numeros_dias','$cidade_destino','$estrela_2','$data_saida','$data_chagada','$valor_passagem')");

} else if ("hotel" == $estrela_3) {

@$pacote=$valor_passagem + ($numero_acompanhantes * $valor_passagem)+ $valor_passagem +( $numeros_dias  * 200);
  mysqli_query($con, "insert into viagem values('',$numero_acompanhantes','$numeros_dias','$cidade_destino','$estrela_3','$data_saida','$data_chagada','$valor_passagem')");

} else if ("hotel" == $estrela_4) {
@$pacote=$valor_passagem + ($numero_acompanhantes * $valor_passagem)+ $valor_passagem +( $numeros_dias  * 370);
  mysqli_query($con, "insert into viagem values('',$numero_acompanhantes','$numeros_dias','$cidade_destino','$estrela_4','$data_saida','$data_chagada','$valor_passagem')");

} else if ("hotel" == $estrela_5) {

@$pacote= $valor_passagem + ($numero_acompanhantes * $valor_passagem)+$valor_passagem +( $numeros_dias *  550);
    mysqli_query($con, "insert into viagem values('',$numero_acompanhantes','$numeros_dias','$cidade_destino','$estrela_5','$data_saida','$data_chagada','$valor_passagem')");
 ...
 mysqli_query($con,"insert into viagem values('',$numero_acompanhantes','$numeros_dias','$cidade_destino','$qualidade_hotel','$data_saida','$data_chagada','$valor_passagem')");
   }
                   ?>
