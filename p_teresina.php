...
<form class="form-horizontal"  method="POST" action="cadastro_viagem.php">
                       <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <input type="text" class="form-control" id="nome" placeholder="Número de  acompanhantes" name="numero_acompanhantes">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <input type="text" class="form-control" id="cpf" placeholder="Tempo de viagem" name="numeros_dias">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <input type="text" class="form-control" id="telefone" placeholder="Destino" name="cidade_destino" >
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <input type="text" class="form-control" id="celular" placeholder="Qualidade do hotel" name="qualidade_hotel">
                            </div>
                       </div>
                       <div class="form-group">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <input type="date" class="form-control" id="estado" placeholder="Data de chagada" name="data_chagada" >
...
if ("hotel" == $estrela_1) {
 @$valor_passagem=300;
  ...
  mysqli_query($con, "insert into viagem values('','$id_cliente','$cpf',$numero_acompanhantes','$numeros_dias','$cidade_destino','$estrela_1','$data_saida','$data_chagada','$valor_passagem','$pacote')");

} else if ("hotel" == $estrela_2) {
 @$pacote=$valor_passagem + ($numero_acompanhantes * $valor_passagem) + $valor_passagem + ($numeros_dias * 150);
    mysqli_query($con, "insert into viagem values('','$id_cliente','$cpf','$numero_acompanhantes','$numeros_dias','$cidade_destino','$estrela_2','$data_saida','$data_chagada','$valor_passagem','$pacote')");

} else if ("hotel" == $estrela_3) {

@$pacote=$valor_passagem + ($numero_acompanhantes * $valor_passagem)+ $valor_passagem +( $numeros_dias  * 200);
  mysqli_query($con, "insert into viagem values('','$id_cliente','$cpf','$numero_acompanhantes','$numeros_dias','$cidade_destino','$estrela_3','$data_saida','$data_chagada','$valor_passagem','$pacote')");

} else if ("hotel" == $estrela_4) {
@$pacote=$valor_passagem + ($numero_acompanhantes * $valor_passagem)+ $valor_passagem +( $numeros_dias  * 370);
  mysqli_query($con, "insert into viagem values('','$id_cliente','$cpf','$numero_acompanhantes','$numeros_dias','$cidade_destino','$estrela_4','$data_saida','$data_chagada','$valor_passagem','$pacote')");

} else if ("hotel" == $estrela_5) {

@$pacote= $valor_passagem + ($numero_acompanhantes * $valor_passagem)+$valor_passagem +( $numeros_dias *  550);
    mysqli_query($con, "insert into viagem values('','$id_cliente','$cpf','$numero_acompanhantes','$numeros_dias','$cidade_destino','$estrela_5','$data_saida','$data_chagada','$valor_passagem','$pacote')");
